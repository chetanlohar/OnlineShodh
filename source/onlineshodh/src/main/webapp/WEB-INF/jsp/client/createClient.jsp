										...
										<tbody>
											<c:forEach var="userdetail" items="${userDetails}">
												<tr class="odd gradeX">
													...
													<td class="center"><a
														data-href="${pageContext.request.contextPath}/admin/clients/delete/${userdetail.userDetailsId}"
														data-toggle="modal" data-target="#confirm-delete"><button class="btn btn-danger btn-xs">Delete</button></a>
													</td>
												</tr>
											</c:forEach>
										</tbody>
