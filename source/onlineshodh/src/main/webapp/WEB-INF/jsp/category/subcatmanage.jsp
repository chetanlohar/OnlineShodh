...
<body>
			...
			<div class="row">
				<div class="col-lg-9">
				<form action="#" class="form-horizontal" id="subcategorymanage">
				  ...
				  <div class="col-lg-12 space">
                                    ...
                                    <div class="col-lg-12 space">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" rows="3" id="subcategorydesc" name="subcategorydesc" ></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="dataTable_wrapper table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            <td>1</td>
                                            <td><img src="<%=request.getContextPath()%>/resources/images/user_pic.jpg" class="img-responsive"  width="50px " height="50px;"/></td>
                                            <td>1</td>
                                            <td>India</td>
                                            <td>India</td>
                                            <td>1</td>
                                            <td><a href="<%=request.getContextPath()%>/prashant/countyupdate" class="edit"><button class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>  Edit</button></a></td>
                                        ...
                                        <tr class="even gradeC">
                                            ...
                                            <td>India</td>
                                            <td>1</td>
                                            <td><a href="<%=request.getContextPath()%>/prashant/countyupdate"><button class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>  Edit</button></a></td>
                                            <td class="center"><button class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>  Delete</button></td>
