...
<body>
			...
			<div class="row">
				<div class="col-lg-9">
				<form action="#" class="form-horizontal" id="categoryupdate">
				  <div class="col-lg-12 space">
                                        <label for="Name" class="col-sm-5 control-label"> Category Name</label>
                                        <div class="input-group">
                                            <span class="input-group-addon"><span
                                                    class="fa fa-user"></span></span> 
                                            <input type="text" class="form-control" id="categorynameup" name="categorynameup" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 space">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" rows="3" id="categorydescup" name="categorydescup" ></textarea>
                                        </div>
                                    </div>
					  ...
					  <div class="col-lg-6 col-lg-offset-6 space">
                                    ...
                                    <button type="reset" class="btn btn-danger">Go Back</button>
                                </div>
					</form>
				</div>
				<!-- /.col-lg-12 -->
