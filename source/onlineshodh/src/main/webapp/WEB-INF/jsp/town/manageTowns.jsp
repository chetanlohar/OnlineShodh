		...
		<div id="page-wrapper" class="page-wrapper-cls">
			<div id="page-inner">
				...
				<div class="row">
					<div class="col-lg-9">
						<form:form
							action="${pageContext.request.contextPath}/admin/towns/save"
							...
							<div class="form-group input-group col-md-9">
								<form:select path="city.state.country.countryId" id="countryId"
									onchange="getState('${pageContext.request.contextPath}')" class="form-control" name="tcountry">
				...
				<div class="row">
					<div class="col-lg-12 space">
						<div class="panel panel-default">
							<div class="panel-heading text-center">Town Management Table</div>
							<!-- /.panel-heading -->
										...
										<tbody>
											...
											<c:forEach var="town" items="${towns}">
												<tr class="odd gradeX">
													...
													<td class="center"><a
														data-href="${pageContext.request.contextPath}/admin/towns/delete/${town.townId}"
