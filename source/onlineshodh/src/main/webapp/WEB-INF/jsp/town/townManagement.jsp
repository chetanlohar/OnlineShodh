...
<div class="row">
			...
			<div class="row">
				...
				<div class="form-group input-group col-md-9">
						...
						<option value="Gujrat">mumbai</option>
						<option value="UK">UK</option>
						</select>
					</div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>Maharastra</td>
                                            <td>India</td>
                                            <td><a href="<%=request.getContextPath()%>/prashant/Townupdate"><button class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>  Edit</button></a></td>
