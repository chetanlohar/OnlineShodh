					...
					<form:form
						...
						<div class="form-group input-group col-md-9">
							...
							<form:select path="state.country.countryId" class="form-control"
								id="countryId" onchange="getState('${pageContext.request.contextPath}')">
						...
						<div class="form-group input-group col-md-9">
							...
							<form:input path="cityName" title="City Name" maxlength="25"
								class="form-control" name="Ccity" size="50" />

							<form:errors path="cityName" cssClass="errors" />

						</div>
						<div class="col-lg-6 col-lg-offset-6 ">
							<button class="btn btn-success add" type="submit" id="updateCity"
								name="updateCity">UPDATE</button>


							<a href="${pageContext.request.contextPath}/admin/cities/"
								class="back">GoBack</a>
