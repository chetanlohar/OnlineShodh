                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>Maharastra</td>
                                            <td>India</td>
                                            <td><a href="<%=request.getContextPath()%>/prashant/cityupdate"><button class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>  Edit</button></a></td>
                                            <td class="center"><a href="<%=request.getContextPath()%>/prashant/statemanage"><button class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>  Delete</button></a></td>
